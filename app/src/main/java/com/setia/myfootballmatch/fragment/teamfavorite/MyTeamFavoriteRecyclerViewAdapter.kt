...
class MyTeamFavoriteRecyclerViewAdapter(
        private val mListener: TeamFavoriteFragment.TeamFavoriteInteractionListener?)
    : RecyclerView.Adapter<MyTeamFavoriteRecyclerViewAdapter.ViewHolder>() {
    ...
    init {
        mOnClickListener = View.OnClickListener { v ->
            ...
            mListener?.onTapTeamFavorite(item)
        }
    }
